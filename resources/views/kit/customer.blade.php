<form action="{{ route('admin.kit.customer.post') }}" method="POST" class="panel panel-default">
    {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group form-element-text ">
                        ...
                        <input id="legal_room" name="legal_room" type="text" value="101" class="form-control">
                    </div>
                </div>
            </div>
            {{--<div class="row">--}}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group form-element-text ">
                        ...
                        <input id="real_street" name="real_street" type="text" value="Учителей" class="form-control">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group form-element-text ">
                        ...
                        <input id="real_house" name="real_house" type="text" value="24" class="form-control">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group form-element-text ">
                ...
                <div class="col-md-4">
                    <div class="form-group form-element-text ">
                        ...
                        <input id="real_room" name="real_room" type="text" value="101" class="form-control">
                    </div>
                </div>
            </div>
            <hr>
