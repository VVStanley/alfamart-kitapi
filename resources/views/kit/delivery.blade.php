<form action="{{ route('admin.kit.delivery.post') }}" method="POST" class="panel panel-default">
    {{ csrf_field() }}
    <div class="form-elements">
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <p class="lead text-center">Доставка груза</p>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group form-element-date ">
                        ...
                        <div class="input-date input-group">
                            <input data-date-format="DD-MM-YYYY" data-date-pickdate="true" data-date-picktime="false"
                                   data-date-useseconds="false" class="form-control" type="text" id="pickup_date" name="pickup_date"
                                   value="20-08-2027">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group form-element-textarea">
                        ...
                        <textarea id="pickup_comment" name="pickup_comment" rows="3" class="form-control"></textarea>
                    </div>
                </div>
            </div>
